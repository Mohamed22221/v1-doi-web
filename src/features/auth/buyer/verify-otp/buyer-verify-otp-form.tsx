    ...
    return (
        <div className="flex flex-col tablet:gap-6 gap-4">
            ...
            <Card className="p-6">
                ...
                <div className="hidden tablet:block text-center mb-3">
                    <p className="text-neutral-400 dark:text-neutral-300 tablet:text-body text-label">
                ...
                <Form {...form}>
                    <form id="otp-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        <div className="flex flex-col items-center justify-center gap-4">
                            ...
                            <span className="flex items-center gap-2 text-primary-500 dark:text-primary-300 font-medium tablet:text-body text-label">
