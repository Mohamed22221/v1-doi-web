...
export async function SellerNav({ roles, locale }: SellerNavProps) {
  return (
    <header className="fixed inset-x-0 top-0 z-40 hidden h-[85px] border-b bg-neutral-10 transition-colors md:block dark:bg-card">
      <PageContainer variant="full" className="flex h-full items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <Button
            variant="outline"
            size="icon"
            className="border-neutral-20 size-[48px] border text-neutral-400 hover:bg-primary-200 dark:hover:bg-primary-500"
            rounded="full"
          >
