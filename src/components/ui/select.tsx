...
import { CheckIcon, ChevronDownIcon, ChevronUpIcon } from "@components/shared/Icon/constant"
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        {icon ?? <ChevronDownIcon className="size-5 text-primary mb-3" />}
