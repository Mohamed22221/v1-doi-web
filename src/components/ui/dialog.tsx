    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      >
        ...
        {showCloseButton && (
          ...
          >
            <Icon icon={XIcon} className="text-primary-400 dark:text-primary-300" />
