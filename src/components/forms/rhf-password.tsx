...
import { EyeIcon, EyeOffIcon } from "@components/shared/icon-base/constant";
                ...
                return (
                    ...
                    >
                        ...
                        <InputGroupAddon align="inline-end">
                            ...
                            >
                                {showPassword ? (
                                    <Icon icon={EyeOffIcon} className="mx-2 size-5 text-primary-400" />
                                ) : (
                                    <Icon icon={EyeIcon} className="mx-2 size-5 text-primary-400" />
                                )}
                            </InputGroupButton>
                        </InputGroupAddon>
                    </InputGroup>
