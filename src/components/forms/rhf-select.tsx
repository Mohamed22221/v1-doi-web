...
> extends BaseRHFProps<TFieldValues, TName> {
    ...
    placeholder?: string
    selectProps?: Omit<React.ComponentPropsWithoutRef<typeof Select>, "onValueChange" | "value" | "defaultValue">
        ...
        >
            {(field) => (
                <Select
                    ...
                    value={field.value}
                >
                    <SelectTrigger icon={icon} {...triggerProps} size={size === "md" ? "default" : size} className={cn(triggerProps?.className)} >
