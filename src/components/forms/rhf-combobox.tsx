...
const ComboboxContent = dynamic(
  () => import("@components/ui/combobox").then((mod) => mod.ComboboxContent),
  { ssr: false },
);
const ComboboxList = dynamic(
  () => import("@components/ui/combobox").then((mod) => mod.ComboboxList),
  { ssr: false },
);
const ComboboxItem = dynamic(
  () => import("@components/ui/combobox").then((mod) => mod.ComboboxItem),
  { ssr: false },
);
const ComboboxEmpty = dynamic(
  () => import("@components/ui/combobox").then((mod) => mod.ComboboxEmpty),
  { ssr: false },
);
